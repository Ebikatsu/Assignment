...
\begin{itemize}
 \item 小型サーバ操作用ホスト
 \lstinputlisting[caption=実行結果]{../SDN1/100.txt}
 \item 通信用ホスト1
 \lstinputlisting[caption=実行結果]{../SDN1/102.txt}
 \item 通信用ホスト2
 \lstinputlisting[caption=実行結果]{../SDN1/103.txt}
\end{itemize}
...
\begin{itemize}
 ...
 \lstinputlisting[caption=実行結果]{../SDN1/ping_ETHER2-server.txt}
...
\bibitem{Backoff} 第6回　イーサネット（その１）　- イーサネットの規格とCSMA/CDアクセス制御方式 (4/5) , http://www.atmarkit.co.jp/ait/articles/0105/23/news004\_4.html
\bibitem{ARP} TCP/IP - ARP , http://www.infraexpert.com/study/tcpip2.html
\bibitem{IP} ipコマンドチートシート https://access.redhat.com/sites/default/files/attachments/rh\_ip\_command\_cheatsheet\_1214\_jcs\_print\_ja4.pdf
\end{thebibliography}
% --- 参考文献リストここまで
%
