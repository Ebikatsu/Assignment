...
\lstinputlisting[caption=$halfadder.sv$,label=Work4HalfAdder]{work4/halfaddersakai.sv}
%\includegraphics[width=5cm]{work4/4-2.PNG}\\
次に、以下の画像のように、$halfadder$のトップモジュールに組み込んだ。\\
\lstinputlisting[caption=$DE2\_TOP.sv$,label=Work4TOP]{work4/DE2_TOP.sv}
